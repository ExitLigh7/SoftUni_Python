...
class MovieApp:
    ...
    def register_user(self, username: str, age: int):
        username_duplication = self._find_user_by_username(username)
        if username_duplication:
    ...
    def upload_movie(self, username: str, movie: Movie):
        ...
        if self._check_if_movie_exists(movie.title):
    ...
    def __str__(self):
        ...
        return (f"All users: {', '.join(usernames) if usernames else 'No users.'}\n"
                f"All movies: {', '.join(movies) if movies else 'No movies.'}")
    ...
    def _check_if_movie_exists(self, title):
