...
class BaseClimber(ABC):
    def __init__(self, name: str, strength: float,  is_prepared: bool = True):
      self.__name = name
    ...
    def __str__(self):
        return (f"{self.__class__.__name__}: /// Climber name: {self.name} * Left strength: {float(self.strength)} "
